...
public class UserSession implements Serializable {
    ...
    public static UserSession Init(User wxUser) {
        ...
        userSession.setNickname(wxUser.getNickname());
        userSession.setOpenid(wxUser.getOpenid());
        userSession.setSubscribe(wxUser.getSubscribe());
        userSession.setCity(wxUser.getCity());
        userSession.setCountry(wxUser.getCountry());

        userSession.setHeadimgurl(wxUser.getHeadimgurl());
        userSession.setLanguage(wxUser.getLanguage());
        userSession.setProvince(wxUser.getProvince());
        userSession.setRemark(wxUser.getRemark());
        userSession.setSex(wxUser.getSex());

        userSession.setSubscribe_scene(wxUser.getSubscribe_scene());
        userSession.setSubscribe_time(wxUser.getSubscribe_time());
        userSession.setGroupid(wxUser.getGroupid());
        userSession.setNickname_emoji(wxUser.getNickname_emoji());
        userSession.setPrivilege(wxUser.getPrivilege());

        userSession.setQr_scene(wxUser.getQr_scene());
