function SelCity(obj,e) {
    var ths = obj;
    var dal = '<div class="_citys"><h2 class="city-title">配送地区</h2><img src="/index/images/close_icon.png" alt="1" class="close-btn" id="cColse" /><ul id="_citysheng" class="_citys0"><li class="citySel" id="sheng">省份</li><li id="shi">城市</li><li id="xian">区县</li></ul><div id="_citys0" class="_citys1"></div><div style="display:none" id="_citys1" class="_citys1"></div><div style="display:none" id="_citys2" class="_citys1"></div></div>';
